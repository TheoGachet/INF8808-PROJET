...
def create_country_medals_csv_by_season():
    ...
    Seules les lignes où une médaille a été remportée et où l'année >= 1992 sont prises en compte.
    """
    ...
    # Filtrer sur l'année (vérifier la présence de la colonne "Year" ou "année")
